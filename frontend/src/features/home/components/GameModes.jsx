  ...
  return (
    <section style={{ padding: '4rem 2rem', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
        {[
          { icon: 'CASUAL', label: 'CASUAL', color: '#00ff88', desc: 'Jump in anytime. Infinite rooms. Pure fun with no pressure.', tag: 'PLAY NOW' },
          { icon: 'RANKED', label: 'COMPETITIVE', color: '#ffd60a', desc: 'Ranked matches. Timed rounds. Climb the leaderboard.', tag: 'COMING SOON' },
        ].map((m, i) => (
          <div key={i} style={{
            ...
            <div style={{ fontSize: '1rem', fontFamily: 'Share Tech Mono', color: m.color, marginBottom: '1rem' }}>{m.icon}</div>
